...
# Formal Ctrl-World ActionFollowingData equal-family mix.
# Protocol: clean : perturbed : random_feasible : counterfactual_replay = 1 : 1 : 1 : 1.
...
export RUN_NAME="${RUN_NAME:-ACWM_ctrlworld_action_following_mix1_chunk32_8gpu_20260630}"
...
exec bash scripts/launch_training.sh action_following_mix1
