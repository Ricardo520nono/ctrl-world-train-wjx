...
# Ctrl-World ActionFollowingData clean-only baseline.
# Training uses expert clean LeRobot only; validation still uses enhanced_v1_split/test_quick.
...
export RUN_NAME="${RUN_NAME:-ACWM_ctrlworld_action_following_clean_chunk32_8gpu_20260630}"
...
export META_ROOT="${META_ROOT:-/mnt/dataset/public_data/cscsx_projects/ctrl_world_train/dataset_meta_info/action_following_chunk32_clean_only}"
