...
# Ctrl-World ActionFollowingData mix4 for test4v2.
# Current-frame conditioning: 1 observed frame + 32 future actions -> 32 future frames.
# Uses Rot6D / 20D actions and RoboTwin full task descriptions.
# Protocol target: sampled chunk count clean:perturbed:random_feasible:counterfactual:exploration = 4:1:1:1:1.
...
export RUN_NAME="${RUN_NAME:-ACWM_ctrlworld_action_following_mix4_test4v2_chunk32_8gpu_current1_future32_fulldesc_rot6d20_20260707}"
...
export LATENT_ROOT="${LATENT_ROOT:-/mnt/dataset/public_data/cscsx_projects/ctrl_world_train/latents/action_following_current1_future32_clean_enhanced_explore_test4v2_fulldesc_rot6d20_20260707}"
export META_ROOT="${META_ROOT:-/mnt/dataset/public_data/cscsx_projects/ctrl_world_train/dataset_meta_info/action_following_current1_future32_clean_enhanced_explore_test4v2_fulldesc_rot6d20_20260707}"
...
export MASTER_PORT="${MASTER_PORT:-29714}"
