...
export RUN_NAME="${RUN_NAME:-ACWM_ctrlworld_action_following_mix4_test4v2_chunk32_8gpu_rot6d20_20260707}"
...
export LATENT_ROOT="${LATENT_ROOT:-/mnt/dataset/public_data/cscsx_projects/ctrl_world_train/latents/action_following_chunk32_clean_enhanced_explore_test4v2_rot6d20_20260707}"
export META_ROOT="${META_ROOT:-/mnt/dataset/public_data/cscsx_projects/ctrl_world_train/dataset_meta_info/action_following_chunk32_clean_enhanced_explore_test4v2_rot6d20_20260707}"
...
export MASTER_PORT="${MASTER_PORT:-29704}"
