...
# Part 1/2 for Ctrl-World 50-task ActionFollowingData precompute.
# Runs shards 08-15 on one 8GPU AIHC job. Merge/stat is done separately
# after both part0 and part1 finish.

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

export RUN_NAME="${RUN_NAME:-ACWM_ctrlworld_afd_precompute_50task_chunk32_8gpu_part1_rgbfix_explore_20260706}"
