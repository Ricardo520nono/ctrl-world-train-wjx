...
# Retry1 part 0/2 for Ctrl-World 50-task ActionFollowingData precompute.
# Runs shards 00-07 on one 8GPU AIHC job. This retry includes safe-cache
# copy fallback for containers without rsync.

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

export RUN_NAME="${RUN_NAME:-ACWM_ctrlworld_afd_precompute_50task_chunk32_8gpu_part0_rgbfix_explore_retry1_20260706}"
