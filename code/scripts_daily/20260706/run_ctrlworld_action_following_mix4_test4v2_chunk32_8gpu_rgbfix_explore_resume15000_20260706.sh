...
# Warm-start continuation for the interrupted 20260705 mix4 4-task run.
...
# remaining 25,000 optimizer steps to reach the original 40k total budget.
...
export RUN_NAME="${RUN_NAME:-ACWM_ctrlworld_action_following_mix4_test4v2_chunk32_8gpu_rgbfix_explore_resume15000_20260706}"
export AF3_CTRLWORLD_ROOT="${AF3_CTRLWORLD_ROOT:-/mnt/dataset/csx_workspace/Ideas/data_AF3/ctrl-world}"
export LATENT_ROOT="${LATENT_ROOT:-/mnt/dataset/public_data/cscsx_projects/ctrl_world_train/latents/action_following_chunk32_clean_enhanced_explore_test4v2_20260705}"
export META_ROOT="${META_ROOT:-/mnt/dataset/public_data/cscsx_projects/ctrl_world_train/dataset_meta_info/action_following_chunk32_clean_enhanced_explore_test4v2_20260705}"
...
export RESUME_CKPT="${RESUME_CKPT:-${AF3_CTRLWORLD_ROOT}/outputs/ACWM_ctrlworld_action_following_mix4_test4v2_chunk32_8gpu_rgbfix_explore_20260705/checkpoint-step15000-epoch1.24.pt}"
...
export MAX_TRAIN_STEPS="${MAX_TRAIN_STEPS:-25000}"
...
export MASTER_PORT="${MASTER_PORT:-29684}"
