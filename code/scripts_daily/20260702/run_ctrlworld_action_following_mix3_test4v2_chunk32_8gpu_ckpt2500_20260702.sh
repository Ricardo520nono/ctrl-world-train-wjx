...
# Formal Ctrl-World ActionFollowingData main mix for the 2026-07-01 test4 task set.
...
export RUN_NAME="${RUN_NAME:-ACWM_ctrlworld_action_following_mix3_test4v2_chunk32_8gpu_ckpt2500_20260702}"
