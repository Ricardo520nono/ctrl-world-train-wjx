...
RUN_NAME="${RUN_NAME:-ACWM_ctrlworld_afd_precompute_test4v2_chunk32_8gpu_20260701}"
...
LATENT_ROOT="${LATENT_ROOT:-${CACHE_ROOT}/action_following_chunk32_clean_enhanced_test4v2_20260701}"
META_ROOT="${META_ROOT:-${TRAIN_PACKAGE_ROOT}/dataset_meta_info/action_following_chunk32_clean_enhanced_test4v2_20260701}"
