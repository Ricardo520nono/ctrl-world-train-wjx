...
# Ctrl-World ActionFollowingData 50-task Rot6D20 precompute.
# Shared cache for clean-only and mix4 training:
#   - clean_train: 50-task clean LeRobot Rot6D actions + legacy clean videos
...
export RUN_NAME="${RUN_NAME:-ACWM_ctrlworld_afd_precompute_50task_chunk32_rot6d20_sharded_20260708}"
...
export LATENT_ROOT="${LATENT_ROOT:-${CACHE_ROOT}/action_following_current1_future32_clean_enhanced_explore_50task_fulldesc_rot6d20_20260708}"
export MIX4_META_ROOT="${MIX4_META_ROOT:-${TRAIN_PACKAGE_ROOT}/dataset_meta_info/action_following_current1_future32_clean_enhanced_explore_50task_fulldesc_rot6d20_20260708}"
export CLEAN_META_ROOT="${CLEAN_META_ROOT:-${TRAIN_PACKAGE_ROOT}/dataset_meta_info/action_following_current1_future32_clean_only_50task_fulldesc_rot6d20_20260708}"
