...
# Part 0/2 for Ctrl-World 50-task Rot6D20 ActionFollowingData precompute.
# Runs shards 00-07 on one 8GPU AIHC job and initializes the shared target root.

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

export RUN_NAME="${RUN_NAME:-ACWM_ctrlworld_afd_precompute_50task_chunk32_rot6d20_frameidxfix_part0_20260711}"
