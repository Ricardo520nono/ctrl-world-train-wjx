...
# Ctrl-World ActionFollowingData clean-only baseline for the test4v2 task set.
# Paired with the 2026-07-05 RGB-fixed / exploration-aware mix4 run.
...
export RUN_NAME="${RUN_NAME:-ACWM_ctrlworld_action_following_clean_test4v2_chunk32_8gpu_rgbfix_explore_20260705}"
