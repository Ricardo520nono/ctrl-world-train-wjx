...
# Canonical enhanced HDF5/video are already semantic RGB; do not R/B swap in loaders.
...
export RUN_NAME="${RUN_NAME:-ACWM_ctrlworld_action_following_mix4_test4v2_chunk32_8gpu_rgbfix_explore_20260705}"
